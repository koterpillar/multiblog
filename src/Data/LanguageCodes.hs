-- This is a copy of Data.LanguageCodes from iso639 package, which is
-- unusable with -Werror because of
-- https://github.com/HugoDaniel/iso639/issues/1
-- Modified to avoid -Werror
